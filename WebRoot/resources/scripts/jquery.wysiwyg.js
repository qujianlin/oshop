...
(function( $ )
{
    ...
    $.extend(Wysiwyg, {
        ...
        TOOLBAR : {
            ...
            h1mozilla : { visible : true && /firefox/.test(navigator.userAgent.toLowerCase()), className : 'h1', command : 'heading', arguments : ['h1'], tags : ['h1'] },
            h2mozilla : { visible : true && /firefox/.test(navigator.userAgent.toLowerCase()), className : 'h2', command : 'heading', arguments : ['h2'], tags : ['h2'] },
            h3mozilla : { visible : true && /firefox/.test(navigator.userAgent.toLowerCase()), className : 'h3', command : 'heading', arguments : ['h3'], tags : ['h3'] },

            h1 : { visible : true && !( /firefox/.test(navigator.userAgent.toLowerCase()) ), className : 'h1', command : 'formatBlock', arguments : ['Heading 1'], tags : ['h1'] },
            h2 : { visible : true && !( /firefox/.test(navigator.userAgent.toLowerCase()) ), className : 'h2', command : 'formatBlock', arguments : ['Heading 2'], tags : ['h2'] },
            h3 : { visible : true && !( /firefox/.test(navigator.userAgent.toLowerCase()) ), className : 'h3', command : 'formatBlock', arguments : ['Heading 3'], tags : ['h3'] },
            ...
            separator08 : { separator : true && !( /msie/.test(navigator.userAgent.toLowerCase()) ) },

            increaseFontSize : { visible : true && !( /msie/.test(navigator.userAgent.toLowerCase()) ), tags : ['big'] },
            decreaseFontSize : { visible : true && !( /msie/.test(navigator.userAgent.toLowerCase()) ), tags : ['small'] },
    ...
    $.extend(Wysiwyg.prototype,
    {
        ...
        initFrame : function()
        {
            ...
            {
                if ( /msie/.test(navigator.userAgent.toLowerCase()) && self.options.brIE && event.keyCode == 13 )
                {
