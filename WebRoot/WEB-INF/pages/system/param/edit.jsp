	    	...
	    	<form action="<%=basePath %>admin/system/param/edit" method="post">
	            ...
	            <table>
	            	<tr>
	            		...
	            		<td>
	            			<input class="text-input input" type="text" id="paramName" name="paramName" value="${param.paramName }"/>
	            		</td>
            		</tr>
            		<tr>
	            		<td><label for="group">参数组</label></td>
	            		<td>
	            			<input class="text-input input" type="text" id="group" name="group" value="${param.group }"/>
            			</td>
	            	</tr>
	            	<tr>
	            		<td><label for="paramValue">参数值</label></td>
	            		<td><input class="text-input input" type="text" id="paramValue" name="paramValue" value="${param.paramValue }"/></td>
            		</tr>
            		<tr>
	            		...
	            		<td>
	            			<select name="modifiable" class="input">
			                	...
			                	<option value="0" <c:if test="${param.modifiable == '1' }">selected="selected"</c:if>>否</option>
	            			</select>
            			</td>
	            	</tr>
	            	<tr>
	            		...
	            		<td>
	            			<select name="init" class="input">
			                	...
			                	<option value="0" <c:if test="${param.init == '1' }">selected="selected"</c:if>>否</option>
	            			</select>
            			</td>
	            	</tr>
	            	<tr>
	            		...
	            		<td>
	            			<textarea class="text-input input" id="remark" name="remark">${param.remark }</textarea>
	            		</td>
            		</tr>
	            	<tr>
	            		<td>
